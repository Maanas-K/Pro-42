...
function preload(){
    ...
    //heroIMG = loadImage("bat/Bestman-01.png");
...
function setup(){
  ...
  //***************************** How to use i ?*******************************\\
   ...
   /*for(var i = 0; i<dropCount; i++){
      //drops[i]= 
      rain.push(drop.createDrop(random(0,400), random(0,400)))

      //rain = [drop=new Rain(random(0,400), random(0,400))]
      //rain[i]= drop=new Rain(random(0,400), random(0,400))
   }*/
...
function draw(){
    ...
    if(frameCount % 1 === 0){
        ...
        drop=new Rain(random(0,400), random(0,400))
